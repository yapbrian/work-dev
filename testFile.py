...
asOfDate = parser.parse("2014-02-25")
...
testClass.loadBondOffTheRunQuotes(asOfDate,5)
...
maturityCutoff = datetime(asOfDate.year, asOfDate.month+6, asOfDate.day)
...
endDate = datetime(settleDate.year+30,settleDate.month,settleDate.day)
